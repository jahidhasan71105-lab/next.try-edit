...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "জাহিদ") || (event.body.toLowerCase() == "jahid") || (event.body.toLowerCase() == "Jahid") || (event.body.toLowerCase() == "JAHID")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ —͟͞͞ᴊ ᴀ͢͢͢ ʜ ɪ ᴅ 𝐌𝑨𝐋𝐒𒁍🐼 ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 jahid.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/virgin.pola.69\nতার সাতে যোগা যোগ করবেন WhatsApp :- +0162243910*", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator: —͟͞͞ᴊ ᴀ͢͢͢ ʜ ɪ ᴅ 𝐌𝑨𝐋𝐒𒁍🐼 ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস জাহিদ আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is Jahid hasan❤️ তাকে সবাই জাহিদ নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "tor bap Jahid ami") || (event.body.toLowerCase() == "sala ami Jahid") || (event.body.toLowerCase() == "chup sala ami jahid") || (event.body.toLowerCase() == "ki bolli")) {
     return api.sendMessage("সরি বস মাফ করে দেন আর এমন ভুল হবে না🥺🙏", threadID);
   };

   if ((event.body.toLowerCase() == "@Maya Aktar Riya") || (event.body.toLowerCase() == "@Rijiya Aktar Maya ")) {
     return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা এটা আমার বস জাহিদ এর বউ এর আইড়ি😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "riya") || (event.body.toLowerCase() == "rijiya")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস জাহিদ এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  
  if ((event.body.toLowerCase() == "Rijiya") || (event.body.toLowerCase() == "")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস জাহিদ এর বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Riya") || (event.body.toLowerCase() == "রিয়া")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস জাহিদ এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
