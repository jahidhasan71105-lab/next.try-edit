...
"https://i.pixxxels.cc/KjPkTtLk/ZvgpHTy.jpg",Oh, this pig is going to break the jar, right?
"https://i.pixxxels.cc/jdM96PZ7/zZKvVvB.jpg",
  ...
  var money = data.money
      if(money < 0) api.sendMessage("Oh, this pig is going to break the jar, right?",event.threadID,event.messageID)
          else {
