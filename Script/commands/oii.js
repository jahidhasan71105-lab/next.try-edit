module.exports.config = {
  ...
  version: "2.0.0",
  hasPermssion: 0,
  credits: "Jahid Pro Edit",
  description: "Stylish random love spam",
  commandCategory: "fun",
  usages: "/valobasha @tag",
  cooldowns: 5
};
...
module.exports.run = async function({ api, event }) {
  ...
  if (!mention) {
    return api.sendMessage("⚠️ কাউকে mention দাও!", event.threadID);
  }
...
" “যতক্ষণ পর্যন্ত না ভালোবাসায় পাগলামো মেশে, ততক্ষন ভালোবাসা গভীর হয় না।”",
  	...
  	"“আমার কথা যত ভুলবার চেষ্টা করবে, আমি তত বেশি করে মনে পড়ব।”", 
            	...
            	"“ভালোবাসার মানে এই নয় যে, তোমার কোনো গার্লফ্রেন্ড বা বয়ফ্রেন্ড থাকবে, ভালোবাসা মানে এক জন কেউ স্পেশাল থাকবে, যার জন্য তুমি চিন্তা করবে এবং সে তোমার জন্য চিন্তা করবে।”",
              	...
              	"ভালবাসা বলতে আমি বুজি —͟͞͞ᴊ ᴀ͢͢͢ ʜ ɪ ᴅ 𝐌𝑨𝐋𝐒𒁍🐼l খুব ভালো ছেলে অর সাথে প্রেম করতে পারেন পোলাটা আর কত সিংগেল থাকবে এইযে JAHID এর আইডির লিং https://www.facebook.com/virgin.pola.69 দিয়ে দিলাম জাও প্রেম করো",
  ];
